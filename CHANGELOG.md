...
* [backupNowDMaaS.ps1](https://github.com/cohesity/community-automation-samples/tree/main/dmaas/powershell/backupNowDMaaS) [`Update`] Added support for SQL
...
* [ccsSlaMonitor.py](https://github.com/cohesity/community-automation-samples/tree/main/dmaas/python/ccsSlaMonitor) [`New`] Monitor for SLA violations in CCS

## 2024-02-21

* [protectCCSEC2VMs.py](https://github.com/cohesity/community-automation-samples/tree/main/dmaas/python/protectCCSEC2VMs) [`New`] Protect EC2 VMs in CCS
...
* [restoreSQL-CCS.ps1](https://github.com/cohesity/community-automation-samples/tree/main/dmaas/powershell/restoreSQL-CCS) [`Update`] added support for SQL Always On Availability Group datbases
...
* [agentStatus.ps1](https://github.com/bseltz-cohesity/scripts/tree/8e79c66c685157d9df2f1e3b893b4d24de70e0b0/reports/powershell/agentStatus) [`Removed`] this script has been superceded by [registeredSources.ps1](https://github.com/cohesity/community-automation-samples/tree/main/reports/powershell/registeredSources)
...
* [protectDmaasM365Mailboxes.ps1](https://github.com/cohesity/community-automation-samples/tree/main/dmaas/powershell/protectDmaasM365Mailboxes) [`Update`] added support for security groups
