...
This PowerShell script turns on auto-protection for all Ccs M365 Sharepoint sites under a registered source, while excluding any sites already protected in other regions.
...
```powershell
# Download Commands
$scriptName = 'autoprotectCcsM365Sites'
...
* [autoprotectCcsM365Sites.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/ccs/powershell/autoprotectCcsM365Sites/autoprotectCcsM365Sites.ps1): the main powershell script
...
* -pageSize (optional) page size for source enum query (default is 25000)
* -searchBatchSize (optional) number of object ids to search for at a time (default is 500)
