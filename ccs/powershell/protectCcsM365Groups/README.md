...
This powershell script protects Ccs M365 Groups.
...
```powershell
# Download Commands
$scriptName = 'protectCcsM365Groups'
...
* [protectCcsM365Groups.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/ccs/powershell/protectCcsM365Groups/protectCcsM365Groups.ps1): the main powershell script
* [cohesity-api.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/powershell/cohesity-api/cohesity-api.ps1): the Cohesity REST API helper module

Place both files in a folder together and run the main script like so:

```powershell
./protectCcsM365Groups.ps1 -policyName Gold `
