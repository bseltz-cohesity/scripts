...
This powershell script protects Ccs M365 Mailboxes from a CSV.
...
```powershell
# Download Commands
$scriptName = 'protectCcsM365MailboxesCSV'
...
* [protectCcsM365MailboxesCSV.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/ccs/powershell/protectCcsM365MailboxesCSV/protectCcsM365MailboxesCSV.ps1): the main powershell script
* [cohesity-api.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/powershell/cohesity-api/cohesity-api.ps1): the Cohesity REST API helper module

Create a CSV file (or export from M365) containing the mailboxes to protect. The two CSV columns that are required for this script are name and smtpAddress. So for example, our CSV file might look like this:
