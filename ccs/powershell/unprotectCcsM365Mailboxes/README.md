...
This powershell script unprotects Ccs M365 Mailboxes.
...
```powershell
# Download Commands
$scriptName = 'unprotectCcsM365Mailboxes'
...
* [unprotectCcsM365Mailboxes.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/ccs/powershell/unprotectCcsM365Mailboxes/unprotectCcsM365Mailboxes.ps1): the main powershell script
* [cohesity-api.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/powershell/cohesity-api/cohesity-api.ps1): the Cohesity REST API helper module

Place both files in a folder together and run the main script like so:

```powershell
./unprotectCcsM365Mailboxes.ps1 -region us-east-2 `
