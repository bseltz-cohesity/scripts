...
This powershell script unprotects Ccs M365 Sharepoint sites from a CSV.
...
```powershell
# Download Commands
$scriptName = 'unprotectCcsM365SitesCSV'
...
* [unprotectCcsM365SitesCSV.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/ccs/powershell/unprotectCcsM365SitesCSV/unprotectCcsM365SitesCSV.ps1): the main powershell script
...
```powershell
./unprotectCcsM365SitesCSV.ps1 -policyName Gold `
...
* -unprotectSubSites: (optional) unprotect any subsites below the specified site
