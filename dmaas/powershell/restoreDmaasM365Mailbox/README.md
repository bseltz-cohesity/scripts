...
```powershell
./restoreDmaasM365Mailbox.ps1 -mailboxes user1.mydomain.onmicrosoft.com, user2.mydomain.onmicrosoft.com
```

## Basic Parameters

* -username: (optional) used for password storage only (default is 'DMaaS')
* -mailboxes: (optional) one or more mailbox names (comma separated)
