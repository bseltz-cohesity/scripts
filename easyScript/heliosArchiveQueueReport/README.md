# Report Helios Archive Queue using EasyScript
...
```bash
# download commands
curl -O https://raw.githubusercontent.com/cohesity/community-automation-samples/main/easyScript/heliosArchiveQueueReport/heliosArchiveQueueReport.zip
