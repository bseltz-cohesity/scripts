# Report Clones and Mounts on Helios Clusters using EasyScript
...
```bash
# download commands
curl -O https://raw.githubusercontent.com/cohesity/community-automation-samples/main/easyScript/heliosCloneReport/heliosCloneReport.zip
