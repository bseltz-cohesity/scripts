...
```bash
# download commands
curl -O https://raw.githubusercontent.com/bseltz-cohesity/scripts/master/helios/python/powerBI-helios-policyDataLockStatus/powerBI-helios-policyDataLockStatus.py
