### usage: ./cloneView30Versions.ps1 -vip 192.168.1.198 -username admin [ -domain local ] -viewName 'SMBShare'
...
if ($viewResult) {
    ...
    1..$VERSIONSTOCLONE | ForEach-Object {
    ...
    # delete old view
    $oldDay = $today.AddDays(-$VERSIONSTOCLONE-1)
    $year = $oldDay.Year
