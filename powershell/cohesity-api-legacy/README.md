# Cohesity API Function Library for PowerShell - Legacy Version
...
(Invoke-WebRequest -UseBasicParsing -Uri "$repoUrl/cohesity-api-legacy/cohesity-api.ps1").content | Out-File -Force cohesity-api.ps1; (Get-Content cohesity-api.ps1) | Set-Content cohesity-api.ps1
...
* -timeout: (optional) default is 300 (seconds)
