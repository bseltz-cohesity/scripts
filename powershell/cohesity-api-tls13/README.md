# Cohesity API Function Library for PowerShell - Tls13 Version
...
(Invoke-WebRequest -UseBasicParsing -Uri "$repoUrl/cohesity-api-tls13/cohesity-api.ps1").content | Out-File -Force cohesity-api.ps1; (Get-Content cohesity-api.ps1) | Set-Content cohesity-api.ps1
