...
* -sourceUserName: (optional) one or more user names or SMTP addresses to download (comma separated)
* -sourceUserList: (optional) text file of user names or SMTP addresses to download (one per line)
