...
This powershell script reports added and deleted objects from one job run to the next, across runs that are in retention.
...
* -numRuns: (optional) default is 100. Can be reduced if too much data is returned
