### usage: ./protectView.ps1 -vip bseltzve01 -username admin -viewName homedirs -policyName 'Standard Protection'
...
param (
    ...
    [Parameter(Mandatory = $True)][string]$viewName, #name of VM to protect
...
if(!$view){
    Write-Warning "View $viewName not found!"
    exit
}
