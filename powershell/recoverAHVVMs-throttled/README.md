...
$scriptName = 'recoverAHVVMs-throttledV2'
(Invoke-WebRequest -UseBasicParsing -Uri "$repoUrl/recoverAHVVMs-throttled/$scriptName.ps1").content | Out-File "$scriptName.ps1"; (Get-Content "$scriptName.ps1") | Set-Content "$scriptName.ps1"
