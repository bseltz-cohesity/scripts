...
* recoverVMv2.ps1: the main powershell script
* cohesity-api.ps1: the Cohesity REST API helper module

Place the files in a folder together and run the main script like so:

```powershell
./recoverVMv2.ps1 -vip mycluster `
                  -username myusername `
                  -domain mydomain.net `
                  -vmName myvm `
...
* -recoveryTytpe: (optional) InstantRecovery or CopyRecovery (default is InstantRecovery)
