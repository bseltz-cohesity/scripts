...
```powershell
./replicateOldSnapshots.ps1 -vip mycluster -username admin -replicteTo CohesityVE -olderThan 1 -IfExpiringAfter 3
```
...
```powershell
./archiveOldSnapshots.ps1 -vip mycluster -username admin -replicteTo CohesityVE -olderThan 1 -IfExpiringAfter 3 -replicate
```
