...
# .\viewDRclone.ps1 -vip $drCluster -username $userName -domain $domain -viewList ./myviews.txt -inPath "$metaDataPath\$primaryCluster" -policyName $policyName -useApiKey
...
# .\viewDRdelete.ps1 -vip $primaryCluster -username $userName -domain $domain -viewList ./myviews.txt -deleteSnapshots -useApiKey
