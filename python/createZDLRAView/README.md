# Create a ZDLRA View using Python
...
```bash
curl -O https://raw.githubusercontent.com/cohesity/community-automation-samples/main/python/createZDLRAView/createZDLRAView.py
...
* [createZDLRAView.py](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/python/createZDLRAView/createZDLRAView.py): the main python script
