# List Helios Self-Managed Backups Using PowerShell
...
* heliosSMBackups.ps1: the main powershell script
* cohesity-api.ps1: the Cohesity REST API helper module

Place both files in a folder together and run the main script like so:

```powershell
./heliosSMBackups.ps1 -vip myhelios.mydomain.net -username myuser
```
...
* -exportConfig: (optional) export s3 backup configuration to a text file
* -hideSecretKey: (optional) hide secfret key from config file export
* -pageSize: (optional) number of backups to retrieve (default is 100)
