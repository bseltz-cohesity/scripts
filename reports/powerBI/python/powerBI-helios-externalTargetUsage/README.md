...
```bash
# download commands
curl -O https://raw.githubusercontent.com/bseltz-cohesity/scripts/master/reports/powerBI/python/powerBI-helios-externalTargetUsage/powerBI-helios-externalTargetUsage.py
