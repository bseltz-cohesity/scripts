# Import Helios External Target Storage Consumption into Power BI using Python
...
```bash
# download commands
curl -O https://raw.githubusercontent.com/cohesity/community-automation-samples/main/reports/powerBI/python/powerBI-helios-externalTargetUsage/powerBI-helios-externalTargetUsage.py
