...
This PowerShell script generates a protection activities report.
...
```powershell
# Download Commands
$scriptName = 'clusterProtectionActivities'
...
* [clusterProtectionActivities.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/reports/powershell/clusterProtectionActivities/clusterProtectionActivities.ps1): the main python script
* [cohesity-api.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/powershell/cohesity-api/cohesity-api.ps1): the Cohesity REST API helper module

Place both files in a folder together and run the main script.

```powershell
./clusterProtectionActivities.ps1 -vip mycluster `
                                  -username myuser `
                                  -domain mydomain.net
```
