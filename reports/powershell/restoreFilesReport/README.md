# Email Restore File Report Using PowerShell
...
* [restoreFilesReport.ps1](https://raw.githubusercontent.com/cohesity/community-automation-samples/main/reports/powershell/restoreFilesReport/restoreFilesReport.ps1): the main powershell script
...
* -startDate: (optional) date range start date
* -endDate: (optional) date range end date
* -lastCalendarMonth: set date range to last calendar month
* -lastXDays: (optional) set date range to last X days
