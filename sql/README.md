...
* restoreSQLv2.ps1: restore a SQL database for operational recovery or testing
...
(Invoke-WebRequest -UseBasicParsing -Uri https://raw.githubusercontent.com/cohesity/community-automation-samples/main/sql/powershell/restoreSQLv2/restoreSQLv2.ps1).content | Out-File restoreSQL.ps1; (Get-Content restoreSQL.ps1) | Set-Content restoreSQL.ps1
